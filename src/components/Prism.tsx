...
const Prism = ({
  ...
  useEffect(() => {
    ...
    if (suspendWhenOffscreen) {
      ...
      startRAF();
      (container as HTMLDivElement & { __prismIO?: IntersectionObserver }).__prismIO =
        io;
    } else {
      startRAF();
    }
    ...
    return () => {
      ...
      if (suspendWhenOffscreen) {
        const io = (container as HTMLDivElement & { __prismIO?: IntersectionObserver })
          .__prismIO;
        if (io) io.disconnect();
        delete (container as HTMLDivElement & { __prismIO?: IntersectionObserver })
          .__prismIO;
      }
